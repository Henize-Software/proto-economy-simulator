...
public class Config_ClassicMap implements Serializable, Cloneable {
    ...
    public int MAX_LABOR = 70;
    public boolean FLAG_NO_FOOD = false;
    public int Lxreg = 0;
    public int Lyreg = 9;
    public int L_xreg = 19;
    public int L_yreg = 19;
    public boolean sequencial = true;

    //food npc
    public byte FOOD_POP = 3;
    ...
    public int Fxreg = 0;
    public int Fyreg = 0;
    public int F_xreg = 19;
    public int F_yreg = 6;

    //tool npc
    public int TOOL_POP = 2;
    ...
    //transporter
    public int TRANSPORT_OVERLOAD = 70;
    public int TRANSPORT_OVERLOAD_RESET = 69;
    public Coordinate trAdd = new Coordinate(10, 16);

    //master
    public Coordinate msAdd = new Coordinate(10, 4);
