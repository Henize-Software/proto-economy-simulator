...
public class Config_BigMap extends Config implements Serializable, Cloneable {
   ...
   public boolean collectTax;
    ...
    public Coordinate trAdd = new Coordinate(19, 14);

    //master
    public Coordinate msAdd = new Coordinate(19, 2);
